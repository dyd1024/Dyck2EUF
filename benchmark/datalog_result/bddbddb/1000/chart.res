...
buddy.dll is in use, linking temporary copy /tmp/buddy7388815358625773643.dll
Could not load BDD package buddy: /tmp/buddy7388815358625773643.dll: /tmp/buddy7388815358625773643.dll: wrong ELF class: ELFCLASS32 (Possible cause: can't load IA 32 .so on a AMD 64 platform)
