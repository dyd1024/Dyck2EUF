...
buddy.dll is in use, linking temporary copy /tmp/buddy7852921355858330430.dll
Could not load BDD package buddy: /tmp/buddy7852921355858330430.dll: /tmp/buddy7852921355858330430.dll: wrong ELF class: ELFCLASS32 (Possible cause: can't load IA 32 .so on a AMD 64 platform)
Using BDD library JFactory 1.20
No machine learning library found, learning disabled.
Opening Datalog program "./Input/bdd_AliasAnalysis_C/1000/darknet.datalog"
1 field domains.
1003 relations.
46578 rules.
