...
buddy.dll is in use, linking temporary copy /tmp/buddy10525227323688016135.dll
Could not load BDD package buddy: /tmp/buddy10525227323688016135.dll: /tmp/buddy10525227323688016135.dll: wrong ELF class: ELFCLASS32 (Possible cause: can't load IA 32 .so on a AMD 64 platform)
