...
buddy.dll is in use, linking temporary copy /tmp/buddy3367381549410433386.dll
Could not load BDD package buddy: /tmp/buddy3367381549410433386.dll: /tmp/buddy3367381549410433386.dll: wrong ELF class: ELFCLASS32 (Possible cause: can't load IA 32 .so on a AMD 64 platform)
Using BDD library JFactory 1.20
No machine learning library found, learning disabled.
Opening Datalog program "./Input/bdd_AliasAnalysis_C/1000/libssh2.a.datalog"
1 field domains.
1003 relations.
66015 rules.
