...
buddy.dll is in use, linking temporary copy /tmp/buddy1190131219146397345.dll
Could not load BDD package buddy: /tmp/buddy1190131219146397345.dll: /tmp/buddy1190131219146397345.dll: wrong ELF class: ELFCLASS32 (Possible cause: architecture word width mismatch)
Using BDD library JFactory 1.20
No machine learning library found, learning disabled.
Opening Datalog program "./bdd_AliasAnalysis/1000/eclipse.datalog"
1 field domains.
1003 relations.
22947 rules.
